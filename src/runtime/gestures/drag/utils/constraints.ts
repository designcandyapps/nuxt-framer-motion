import { progress as calcProgress } from '#motion/utils/progress'
...
import type {
  ...
  Box,
  Point
} from '#motion/projection/geometry/types'
import { clamp } from '#motion/utils/clamp'
import { mixNumber } from '#motion/utils/mix/number'
import type { DragElastic, ResolvedConstraints } from '#motion/gestures/drag/types'
