...
import type { PanInfo } from '#motion/gestures/pan/PanSession'
import type { Inertia, TargetAndTransition } from '#motion/types'
import type { DragControls } from '#motion/gestures/drag/useDragControls'
import type { MotionValue } from '#motion/value'
import type { VariantLabels } from '#motion/motion/types'
import type { Axis, BoundingBox } from '#motion/projection/geometry/types'
...
export interface DraggableProps extends DragHandlers {
   ...
   * ```
   */
  dragConstraints?: false | Partial<BoundingBox> | Ref<HTMLElement>
