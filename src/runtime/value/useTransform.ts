...
import { transform, type TransformOptions } from '#motion/utils/transform'
import { useCombineMotionValues } from '#motion/value/useCombineValues'
import { useConstant } from '#motion/utils/useConstant'
import { useMotionComputed } from '#motion/value/useMotionComputed'
...
export function useTransform<I, O>(
  ...
  if (typeof input === 'function') {
    return useMotionComputed(input)
  }
