import type { CSSVariableToken } from '#motion/render/dom/utils/isCSSVariable'
import { color } from '#motion/value/types/color'
import type { Color } from '#motion/value/types/types'
import { colorRegex } from '#motion/value/types/utils/colorRegex'
