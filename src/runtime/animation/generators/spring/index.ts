...
import type { SpringOptions, ValueAnimationOptions } from '#motion/animation/types'
import type { AnimationState, KeyframeGenerator } from '#motion/animation/generators/types'
import { calcGeneratorVelocity } from '#motion/animation/generators/utils/velocity'
import { calcAngularFreq, findSpring } from '#motion/animation/generators/spring/find'
