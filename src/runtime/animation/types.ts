import type { KeyframeResolver } from '#motion/render/utils/KeyframesResolver'
...
import type { Driver } from '#motion/animation/animators/drivers/types'
import type { SVGPathProperties, VariantLabels } from '#motion/motion/types'
import type { SVGAttributes } from '#motion/render/svg/typesAttributes'
import type { ProgressTimeline } from '#motion/render/dom/scroll/observe'
import type { MotionValue } from '#motion/value'
import type { KeyframeGenerator } from '#motion/animation/generators/types'
