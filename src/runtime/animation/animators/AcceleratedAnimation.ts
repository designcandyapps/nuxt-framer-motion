...
import { backInOut } from '#motion/easing/back'
import { circInOut } from '#motion/easing/circ'
import type { EasingDefinition } from '#motion/easing/types'
import { DOMKeyframesResolver } from '#motion/render/dom/DOMKeyframesResolver'
import type { ResolvedKeyframes } from '#motion/render/utils/KeyframesResolver'
...
import {
  BaseAnimation,
  type ValueAnimationOptionsWithDefaults
} from './BaseAnimation'
import { MainThreadAnimation } from './MainThreadAnimation'
import { acceleratedValues } from './utils/acceleratedValues'
import { startWaapiAnimation } from './waapi'
import { isWaapiSupportedEasing } from './waapi/easing'
import { attachTimeline } from './waapi/utils/attachTimeline'
import { getFinalKeyframe } from './waapi/utils/getFinalKeyframe'
import { supportsLinearEasing } from './waapi/utils/supportsLinearEasing'
import { supportsWaapi } from './waapi/utils/supportsWaapi'
...
> extends BaseAnimation<T, ResolvedAcceleratedAnimation> {
  declare protected options: ValueAnimationOptionsWithDefaults<T> & {
    name: string
    motionValue: MotionValue<T>
  }
