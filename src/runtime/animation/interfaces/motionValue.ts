...
import type { MotionValue, StartAnimation } from '#motion/value'
import { getDefaultTransition } from '#motion/animation/utils/defaultTransitions'
...
import { MotionGlobalConfig } from '#motion/utils/GlobalConfig'
import { instantAnimationState } from '#motion/utils/useInstantTransitionState'
...
import { AcceleratedAnimation } from '#motion/animation/animators/AcceleratedAnimation'
import { MainThreadAnimation } from '#motion/animation/animators/MainThreadAnimation'
import { GroupPlaybackControls } from '#motion/animation/GroupPlaybackControls'
import { isTransitionDefined } from '#motion/animation/utils/isTransitionDefined'
