...
export const MotionBlockquote = /* @__PURE__ */ createMotionComponent('blockquote')
...
export const MotionFigcaption = /* @__PURE__ */ createMotionComponent('figcaption')
...
export const MotionFeColorMatrix = /* @__PURE__ */ createMotionComponent('feColorMatrix')
export const MotionFeComponentTransfer = /* @__PURE__ */ createMotionComponent('feComponentTransfer')
export const MotionFeComposite = /* @__PURE__ */ createMotionComponent('feComposite')
export const MotionFeConvolveMatrix = /* @__PURE__ */ createMotionComponent('feConvolveMatrix')
export const MotionFeDiffuseLighting = /* @__PURE__ */ createMotionComponent('feDiffuseLighting')
export const MotionFeDisplacementMap = /* @__PURE__ */ createMotionComponent('feDisplacementMap')
export const MotionFeDistantLight = /* @__PURE__ */ createMotionComponent('feDistantLight')
export const MotionFeDropShadow = /* @__PURE__ */ createMotionComponent('feDropShadow')
...
export const MotionFeGaussianBlur = /* @__PURE__ */ createMotionComponent('feGaussianBlur')
...
export const MotionFeMergeNode = /* @__PURE__ */ createMotionComponent('feMergeNode')
export const MotionFeMorphology = /* @__PURE__ */ createMotionComponent('feMorphology')
export const MotionFeOffset = /* @__PURE__ */ createMotionComponent('feOffset')
export const MotionFePointLight = /* @__PURE__ */ createMotionComponent('fePointLight')
export const MotionFeSpecularLighting = /* @__PURE__ */ createMotionComponent('feSpecularLighting')
export const MotionFeSpotLight = /* @__PURE__ */ createMotionComponent('feSpotLight')
export const MotionFeTile = /* @__PURE__ */ createMotionComponent('feTile')
export const MotionFeTurbulence = /* @__PURE__ */ createMotionComponent('feTurbulence')
export const MotionForeignObject = /* @__PURE__ */ createMotionComponent('foreignObject')
export const MotionLinearGradient = /* @__PURE__ */ createMotionComponent('linearGradient')
export const MotionRadialGradient = /* @__PURE__ */ createMotionComponent('radialGradient')
