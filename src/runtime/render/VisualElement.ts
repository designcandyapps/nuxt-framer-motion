...
import type { FeatureDefinitions } from '#motion/motion/features/types'
...
import { initPrefersReducedMotion } from '#motion/utils/reducedMotion'
import {
  hasReducedMotionListener,
  prefersReducedMotion
} from '#motion/utils/reducedMotion/state'
import { SubscriptionManager } from '#motion/utils/subscriptionManager'
import { motionValue, type MotionValue } from '#motion/value'
...
} from '#motion/render/types'
import type { AnimationState } from '#motion/render/utils/animationState'
import {
  isControllingVariants as checkIsControllingVariants,
  isVariantNode as checkIsVariantNode
} from '#motion/render/utils/isControllingVariants'
import { updateMotionValuesFromProps } from '#motion/render/utils/motionValues'
...
import { KeyframeResolver } from '#motion/render/utils/KeyframesResolver'
import { isNumericalString } from '#motion/utils/isNumericalString'
import { isZeroValueString } from '#motion/utils/isZeroValueString'
import { findValueType } from '#motion/render/dom/valueTypes/find'
