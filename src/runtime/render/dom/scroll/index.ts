import type { OnScroll, OnScrollWithInfo, ScrollOptions } from '#motion/render/dom/scroll/types'
import { scrollInfo } from '#motion/render/dom/scroll/track'
import type { GroupPlaybackControls } from '#motion/animation/GroupPlaybackControls'
import { observeTimeline, type ProgressTimeline } from '#motion/render/dom/scroll/observe'
import { supportsScrollTimeline } from '#motion/render/dom/scroll/supports'
