import { isNone } from '#motion/animation/utils/isNone'
import { getVariableValue } from '#motion/render/dom/utils/cssVariablesConversion'
import { isCSSVariableToken } from '#motion/render/dom/utils/isCSSVariable'
import {
  isNumOrPxType,
  positionalKeys,
  positionalValues
} from '#motion/render/dom/utils/unitConversion'
import { findDimensionValueType } from '#motion/render/dom/valueTypes/dimensions'
import {
  type OnKeyframesResolved,
  type UnresolvedKeyframes,
  KeyframeResolver
} from '#motion/render/utils/KeyframesResolver'
import { makeNoneKeyframesAnimatable } from '#motion/render/html/utils/makeNoneAnimatable'
