...
import { mixColor } from '#motion/utils/mix/color'
import { pipe } from '#motion/utils/pipe'
import { warning } from '#motion/utils/errors'
import type { HSLA, RGBA } from '#motion/value/types/types'
import { color } from '#motion/value/types/color'
import {
  analyseComplexValue,
  complex,
  type ComplexValueInfo,
  type ComplexValues
} from '#motion/value/types/complex'
import { isCSSVariableToken } from '#motion/render/dom/utils/isCSSVariable'
import { invisibleValues, mixVisibility } from '#motion/utils/mix/visibility'
