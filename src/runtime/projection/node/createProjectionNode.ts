...
import { SubscriptionManager } from '#motion/utils/subscriptionManager'
import { mixValues } from '#motion/projection/animation/mixValues'
import { copyAxisDeltaInto, copyBoxInto } from '#motion/projection/geometry/copy'
import { getOptimisedAppearId } from '#motion/animation/optimizedAppear/getAppearId'
import { applyBoxDelta, applyTreeDeltas, transformBox, translateAxis } from '#motion/projection/geometry/deltaApply'
import {
  calcBoxDelta,
  calcLength,
  calcRelativeBox,
  ...
  isNear
} from '#motion/projection/geometry/deltaCalc'
import { removeBoxTransforms } from '#motion/projection/geometry/deltaRemove'
import type { Axis, AxisDelta, Box, Delta, Point } from '#motion/projection/geometry/types'
...
import {
  ...
  boxEqualsRounded,
  isDeltaZero
} from '#motion/projection/geometry/utils'
import type { NodeStack } from '#motion/projection/shared/stack'
import { scaleCorrectors } from '#motion/projection/styles/scaleCorrection'
import { buildProjectionTransform } from '#motion/projection/styles/transform'
import { eachAxis } from '#motion/projection/utils/eachAxis'
import { has2DTranslate, hasScale, hasTransform } from '#motion/projection/utils/hasTransform'
import type {
  IProjectionNode,
  LayoutEvents,
  LayoutUpdateData,
  ...
  ScrollMeasurements
} from '#motion/projection/node/types'
import { FlatTree } from '#motion/render/utils/flatTree'
...
import { delay } from '#motion/utils/delay'
import { mixNumber } from '#motion/utils/mix/number'
import type { Process } from '#motion/frameloop/types'

import type { VisualElement } from '#motion/render/VisualElement'
import { createBox, createDelta } from '#motion/projection/geometry/models'
